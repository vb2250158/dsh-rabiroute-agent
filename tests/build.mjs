...
for (const name of ['workspace-plans.js', 'plan-resources.js', 'plan-resources-install.js', 'plan-context.js', 'plan-events.js', 'plan-status.js', 'workspace-skills.js', 'index.js', 'connection.js', 'plan-panel.js', 'locate-agent.js', 'speech.js', 'speech-asr.js', 'message-mode.js']) await copyFile(new URL('src/' + name, root), new URL('lib/' + name, root))
...
const modules = ['message-envelope.js', 'client-locales.js', 'client-plan-locales.js', 'client-styles.js', 'plan-icon.js', 'client-plan.js', 'client-plan-status-store.js', 'client-plan-status.js', 'client-workspace-plans.js', 'client-speech.js', 'client-question.js', 'client.js']
