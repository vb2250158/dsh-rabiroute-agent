...
for (const name of ['index.js', 'connection.js', 'plan-panel.js', 'locate-agent.js', 'speech.js']) await copyFile(new URL('src/' + name, root), new URL('lib/' + name, root))
...
const modules = ['message-envelope.js', 'client-locales.js', 'client-plan-locales.js', 'client-styles.js', 'plan-icon.js', 'client-plan.js', 'client-speech.js', 'client.js']
