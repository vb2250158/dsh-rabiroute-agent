...
for (const name of ['index.js', 'connection.js', 'plan-panel.js', 'locate-agent.js', 'speech.js', 'speech-asr.js']) await copyFile(new URL('src/' + name, root), new URL('lib/' + name, root))
