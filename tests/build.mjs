...
const modules = ['message-envelope.js', 'client-locales.js', 'client-plan-locales.js', 'client-styles.js', 'plan-icon.js', 'client-plan.js', 'client-plan-status-store.js', 'client-plan-status.js', 'client-workspace-plan-store.js', 'client-workspace-plans.js', 'client-speech.js', 'client-question.js', 'client.js']
