...
for (const name of ['plan-context.js', 'plan-events.js', 'plan-status.js', 'workspace-skills.js', 'index.js', 'connection.js', 'plan-panel.js', 'locate-agent.js', 'speech.js', 'speech-asr.js', 'message-mode.js']) await copyFile(new URL('src/' + name, root), new URL('lib/' + name, root))
