...
export const RABIROUTE_AGENT_PLUGIN_VERSION = '0.1.2'
  ...
  return [
    {
      ...
      parameters: { requestJson: { type: 'string', required: true, description: 'Complete /api/agent/threads JSON request.' } },
      output,
    ...
    },
    {
      ...
      parameters: { requestJson: { type: 'string', required: true, description: 'Complete /api/agent/send JSON request.' } },
      output,
      timeoutMs: requestTimeoutMs,
      async execute(args, exec) {
    ...
    },
    {
      ...
      parameters: {
        method: { type: 'string', required: true, description: 'GET, POST, PUT, or PATCH.' },
        path: { type: 'string', required: true, description: 'Manager API path beginning with an allowed prefix.' },
